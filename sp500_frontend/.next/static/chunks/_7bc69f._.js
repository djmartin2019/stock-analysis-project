(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_7bc69f._.js", {
...
function PerformanceChart({ data, ticker }) {
    ...
    const filteredData = data.filter((stock)=>stock.Ticker === ticker && (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$dayjs$2f$dayjs$2e$min$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(stock.Date).isBetween(startDate, endDate, "day", "[]")).map((stock)=>({
            ...stock,
...
_s(PerformanceChart, "+uuG8ZOwOaa2Z4U0i43s/DSTios=");
...
//# sourceMappingURL=_7bc69f._.js.map