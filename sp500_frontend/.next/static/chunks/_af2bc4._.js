...
(()=>{
    const e = new Error("Cannot find module '@/components/StockTable'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
})();
(()=>{
    const e = new Error("Cannot find module '@/components/PerformanceChart'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
})();
;
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Home.useEffect": ()=>{
            async function loadData() {
                setSP500(await fetchSP500Overview());
                setTopStocks(await fetchTopPerformers());
                setBottomStocks(await fetchBottomPerformers());
            }
            loadData();
        }
    }["Home.useEffect"], []);
