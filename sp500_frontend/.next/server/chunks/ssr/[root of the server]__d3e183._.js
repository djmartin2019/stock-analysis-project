...
function PerformanceChart({ data, ticker }) {
    ...
    const filteredData = data.filter((stock)=>stock.Ticker === ticker && stock.Year >= 2023) // Only show 2023-2024
    .map((stock)=>({
            ...stock,
...
function RootLayout({ children }) {
    const [selectedTicker, setSelectedTicker] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])("AAPL"); //Default to AAPL
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__d3e183._.js.map